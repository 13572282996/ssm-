        ...
        <tr>
  		...
  		<table cellpadding="0" cellspacing="0" id="addtable"> 
	  	            <tr>
	  		            ...
	  		            <td class="right"><input type="text" lay-verify="required" name="type" class="layui-input" value="${thingtype2.type}" /></td>
	  	            </tr>
	  	            <tr>
	  		            <td class="left">&nbsp;</td>
...
layui.use(['form', 'layedit', 'laydate','layer'], function(){
   ...
   //监听提交
     form.on('submit(demo1)', function(data){
	       $("#sqlform").form("submit",{
				url : "${basePath}thingtype2/add.do?id=${thingtype2.id}",
				onSubmit : function() { },
